...
import color1 from '../images/colores/00ffff.png';
import color2 from '../images/colores/003fff.png';
import color3 from '../images/colores/bf001f.png';
  ...
  return (
    <div className="min-h-screen bg-white">
      <header className="flex justify-between items-center p-4 bg-[#003049] shadow-lg">
        ...
        <div>
          <Link to="/login" className="mr-10 font-bold text-white underline underline-offset-2">
            Iniciar Sesión
          </Link>
          <Link
            to="/register"
      ...
      <div className="relative mt-10 h-[500px] ml-[130px] w-[1250px] overflow-hidden flex justify-center items-center bg-black">
        {images.map((img, i) => (
          <img
            key={i}
            src={img}
            className={`absolute h-[500px] w-full max-w-full transition-opacity duration-700 ${
